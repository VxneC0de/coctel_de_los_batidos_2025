...
switch($hidden){
  case 1:
    ...
    if($union_1[0]>0){
      header("location:../visual/sing_in/sing_in.php?answer=3");
    }else if($union_2[0]>0){
      header("location:../visual/sing_in/sing_in.php?answer=4");
    }else{

      $sql = "insert into user values('', '', '$nickRegister', '$emailRegister', MD5('$confirmRegister'), '$countryCode', '$phoneNumber', 0, 0)";

      if(mysqli_query($connection, $sql)){
        header("location:../visual/sing_in/sing_in.php?answer=1");
      }else{
        header("location:../visual/sing_in/sing_in.php?answer=2");
      }
  ...
  case 2:
    ...
    if($v = mysqli_fetch_array($conne)){
      ...
      header("location:../visual/sing_in/sing_in.php?answer=5");
    }
  ...
  case 3:
    ...
    session_unset();
    session_destroy();
    header("location:../visual/sing_in/sing_in.php");
